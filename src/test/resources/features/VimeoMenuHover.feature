Feature: Vimeo hover over menu color
  ...
  Scenario Outline: User hovers the mouse over a top menu dropdown list button
    ...
    Then The color of a <xpath_second> button when hovering over the mouse should be <color> lightgray
    ...
    |"https://vimeo.com/"   | "/html/body/main/div/div[2]/div/div[1]/div[1]/div[1]/ul/li[3]/div[1]"   | "/html/body/main/div/div[2]/div/div[1]/div[1]/div[1]/ul/li[3]/div[2]/ul/li[3]"              | "rgba(238, 241, 242, 0.5)"    |